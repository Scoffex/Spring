...
@Repository
public interface ClientAccountBankRepo extends JpaRepository<BankAccount, String>{
 
	@Query(nativeQuery = true, value=Constants.FIND_BY_CLIENT_ID)
    public List<BankAccount> findByClientId(String id) throws EntityNotFoundException;
