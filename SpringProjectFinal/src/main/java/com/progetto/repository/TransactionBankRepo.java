...
@Repository
public interface TransactionBankRepo extends JpaRepository<Transaction, Integer>{
 

    @Query(nativeQuery = true, value = Constants.FIND_TRANSACTION_BY_BANK_ACOOUNT_ID )
    public List<Transaction> findTransactionByBankAccounId(int id) throws EntityNotFoundException;
